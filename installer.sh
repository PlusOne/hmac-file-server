...
# Help function
show_help() {
    echo -e "${BLUE}HMAC File Server 3.4.0 'Cascade' Installer${NC}"
    echo ""
    echo "Usage: $0 [OPTION]"
    echo ""
    echo "Options:"
...
generate_docker_config() {
    ...
    cat > "$CONFIG_DIR/config.toml" << EOF
# HMAC File Server 3.4.0 "Cascade" Configuration for Docker
# Generated by installer on $(date)
...
print_completion_info() {
    ...
    echo -e "${GREEN}----------------------------------------------------------------${NC}"
    echo -e "${GREEN}         HMAC File Server 3.4.0 Successfully Deployed!        ${NC}"
    echo -e "${GREEN}----------------------------------------------------------------${NC}"
    echo ""
